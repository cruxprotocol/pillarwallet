...
// CRUXPAY FLOW
export const CRUXPAY_INTRO = 'CRUXPAY_INTRO';
export const CRUXPAY_REGISTRATION = 'CRUXPAY_REGISTRATION';
export const CRUXPAY_INJECTED_SCREEN = 'CRUXPAY_INJECTED_SCREEN';
